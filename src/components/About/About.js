  ...
  return(
      <section className='section-about'>
        <div className='u-center-text u-margin-bottom-big'>
          <h2 className='heading-secondary'>Your next website by us</h2>
        </div>
        <div className='row'>
          <div className='col-1-of-2'>
           ...
           <p className='paragraph'>We help grow organizations by building web base application and give them the online presense they have been looking for.</p>
           <h3 className='heading-teritary u-margin-bottom-small'>
             Oh yes! We desing products too..
           </h3>
           <p className='paragraph'>That means we have all packages you just need to see which one is right for you! Please contact us to discuss further.</p>
