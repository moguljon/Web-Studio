    ...
    return(
        <section className='bottom'>
            <div className='bottom__img-container'>
                <svg height="100" width="100" fill="#869df1" xmlns="http://www.w3.org/2000/svg" style={{height: '70'}}>
            ...
            <div className='bottom__container'>
                ...
                <div className='bottom__items'>
                    <a href='https://newsletter.webstudios.io/' className='bottom__item'>Newsletter |</a>
                </div>
                <div className='bottom__items'>
